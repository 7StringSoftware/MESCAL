...
class MeshGradientEditor : public juce::Component
{
public:
    MeshGradientEditor();
...
private:
    ...
    struct PatchComponent : public juce::Component
    {
        ...
        void paint(juce::Graphics& g) override;
        void build(std::shared_ptr<mescal::MeshGradient::Vertex> topLeftVertex, MeshGradientEditor& owner);
        void mouseUp(const juce::MouseEvent& e) override;
    ...
    JUCE_DECLARE_NON_COPYABLE_WITH_LEAK_DETECTOR(MeshGradientEditor)
};
#endif
